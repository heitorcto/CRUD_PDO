...
<form class='login-form' action="inserir.php" method="POST">
    <div class="flex-row">
        <input name="nome" class='lf--input' placeholder='Nome' type='text' required>
    </div>
    <div class="flex-row">
    ...
    <input class='lf--submit' type='submit' value="Cadastrar-se">
</form>
